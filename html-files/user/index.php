...
<body>
  ...
  <div id="content">
    ...
    <h2>
      ...
      <a href="../../html-files/user/animals.html" class="link">Δες τη λίστα</a>
      με τα ζωάκια που χρειάζονται τη βοήθειά σου και μόλις αποφασίσεις για
      ποιον τετράποδο φίλο ενδιαφέρεσαι, συμπλήρωσε μία αίτηση για υιοθεσία.
      Μη διστάσεις να
    ...
    <div style="display: flex; justify-content: space-between; margin-top: 20px">
      <img src="../../images/index-cat.jpg" alt="Cartoon Cat Picture" style="width: 10%" />
      ...
      <img src="../../images/index-dog.jpg" alt="Cartoon Dog Picture" style="width: 10%" />
    </div>
    ...
    <div class="info">
      ...
      <p>
        Το καταφύγιο έχει ανάγκη για εθελοντές. <a href="../../html-files/user/contact.html" class="link"
          style="color: white;">Επικοινώνησε</a> μαζί μας
