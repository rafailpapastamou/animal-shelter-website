...
<body>
  ...
  <div id="content">
    ...
    <h2 class="animalShelterInfoText">
      ...
      <h2 class="animalShelterInfoText"></h2>

      <h2 class="animalShelterInfoText"><a href="../../html-files/user/animals.html" class="link">Δες τη λίστα</a>
        ...
        <h2 class="animalShelterInfoText">Μη διστάσεις να
